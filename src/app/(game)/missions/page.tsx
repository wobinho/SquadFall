  ...
  return (
    <div style={{ width: '100%' }}>
      <div style={{ marginBottom: '32px' }}>
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '11px', letterSpacing: '0.25em', color: '#e8a736', textTransform: 'uppercase', marginBottom: '6px' }}>
          Tactical Operations · Wave Defense
        </div>
      ...
      <div style={{ background: '#14171c', border: '1px dashed #3a3f48', padding: '80px 40px', textAlign: 'center' }}>
        ...
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', letterSpacing: '0.15em', color: '#3a3f48', textTransform: 'uppercase', marginTop: '12px' }}>
          Wave defense runs, loot drops, and tactical objectives
        </div>
      </div>
    </div>
  )
